...
class bdd100k_disimilar(imdb):
    def __init__(self, image_set, devkit_path=None):
        imdb.__init__(self, 'bdd100k_disimilar_' + image_set)
        self._year = 2007
        self._image_set = image_set
        self._devkit_path = cfg_d.BDD100K_disimilar
        self._data_path = os.path.join(self._devkit_path)
        self._classes = ('__background__',  # always index 0
                         'bus', 'bike', 'car', 'motor', 'person', 'rider', 'train', 'truck')
    ...
    def _get_voc_results_file_template(self, output_dir):
        ...
        filedir = output_dir
        # os.path.join(self._devkit_path, 'results', 'cityscape', 'Main')
