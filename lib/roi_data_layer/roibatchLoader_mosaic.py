...
from roi_data_layer.minibatch_mosaic import get_minibatch, get_minibatch
...
class roibatchLoader(data.Dataset):
  ...
  def __getitem__(self, index):
    ...
    random_indexs = [random.randint(0, len(self._roidb) - 1) for _ in range(3)]
    random3db = [self._roidb[random_index] for random_index in random_indexs]
    blobs = get_minibatch(minibatch_db, self._num_classes, random3db,
